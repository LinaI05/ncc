...
void addDepressionPlan(startDate) {
  MyList.meetings.add(Meeting(
    ...
    background: const Color(0xFFCF726A),
    isAllDay: true,
    description: "Depression Coping Plan",
  ));
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 1)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 2)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 3)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 4)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 5)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 6)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 7)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 8)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 9)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 10)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 11)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 12)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 13)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 14)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 15)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 16)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 17)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 18)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 19)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 20)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 21)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 22)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 23)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 24)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 25)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 26)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 27)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 28)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 29)),
  ...
  MyList.meetings.add(Meeting(
    from: startDate.add(const Duration(days: 30)),
