...
void addAnxietyPlan(startDate) {
  MyList.meetings.add(Meeting(
    ...
    background: const Color(0xFF78BA7D),
    isAllDay: true,
    description: "Anxiety Coping Plan",
  ));
  MyList.meetings.add(Meeting(
  ...
  MyList.meetings.add(Meeting(
    ...
    eventName: 'Breathing with Purpose, Guided PEMS',
    background: const Color(0xFF78BA7D),
    isAllDay: true,
    description: "Anxiety Coping Plan",
  ));
  ...
  MyList.meetings.add(Meeting(
    ...
    eventName: 'Guided Rejuvenation, Guided PEMS',
    background: const Color(0xFF78BA7D),
    isAllDay: true,
    description: "Anxiety Coping Plan",
  ));
