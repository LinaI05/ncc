...
class _JournalPageState extends State<JournalPage> {
  ...
  String getRandomGreeting() {
    ...
    return 'click here to start typing';
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Center(
                  child: Text(
                    'Click on the + sign to add new entry\n Swipe left to see your past entries!',
                    style: TextStyle(
                      color: Colors.black,
      ...
      endDrawer: Theme(
        data: Theme.of(context).copyWith(
          ...
          canvasColor: MediaQuery.of(context).platformBrightness ==
              ...
              ? Colors.white
              : Color(
                  0xFFA686C7), //or any other color you want. e.g Colors.blue.withOpacity(0.5)
        ),
        child: Drawer(
          // Add a ListView to the drawer. This ensures the user can scroll
          // through the options in the drawer if there isn't enough vertical
                  ...
                  children: [
                    ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return ListTile(
                            tileColor:
                                currentNoteIndex == index ? Colors.white : null,
